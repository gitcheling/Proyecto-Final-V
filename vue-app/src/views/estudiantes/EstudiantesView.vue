...
<script setup>
    ...
    // ----------------------------------- Importaciones ----------------------------------------
        ...
        import StudentFormModal from './FormularioEstudiantesView.vue';
    ...
    // ----------------------------------- Funciones ----------------------------------------
      ...
      // ----------------------------------- API ----------------------------------------
             ...
             */
            const loadStudents = async (currentFilters = {}) => {
                ...
                try {
                    ...
                    error('Error de Servidor', 'No se pudieron obtener los datos de los estudiantes. Intente de nuevo.');
                } finally {
            ...
            */   
            const addStudent = async (newStudentData) => {
                try {
                    ...
                    const response = await api.post(rutaCrear, newStudentData);

                    // Mostrar alerta de éxito al usuario
                    exito('Éxito', 'Estudiante registrado correctamente.');
