    ...
    <Transition name="modal-drop">
        ...
        <form @submit.prevent="submitForm">
            ...
            <div class="row">
                ...
                <div v-if="!newStudent.id" class="form-group col-12 col-lg-6">
                ...
                <div v-if="newStudent.id" class="form-group col-12 col-lg-6">
                    <label for="estado">Estado académico: <span class="asterisc">*</span></label>
                    <select 
                        id="estado" 
...
<script setup>
  ...
  // ----------------------------------- Variables ----------------------------------------
        ...
        // Rutas
            ...
            const rutaBaseEstadoAcademico = "/EstadoAcademico/"

            // Buscar entidades
            const rutaBuscar = `${rutaBase}Buscar`

            // Crear estudiante
            const rutaObtenerEstadosAcademicos = `${rutaBaseEstadoAcademico}ObtenerEstadosAcademicos`
      ...
      // ----------------------------------- Propiedades ----------------------------------------
            ...
            const emit = defineEmits(['close', 'add-student', 'update-status']);
      ...
      // ----------------------------------- Modal ----------------------------------------
            ...
            const modalTitle = computed(() => {
                ...
                return hasId ? 'Editar Estudiante' : 'Registrar Nuevo Estudiante';
            }); 
      ...
      // ----------------------------------- Formulario ----------------------------------------
        ...
        const isEditMode = computed(() => !!newStudent.value.id);
        ...
        // ----------------------------------- Funciones del Formulario ----------------------------------------
            ...
            function searchEntities() {
                ...
                if (query.length < 2) { // Se recomienda buscar solo con 2 o más caracteres
                    newStudent.value.entidadId = null;
                    entidadSeleccionada.value = null;
                    return;
                }
            ...
            function selectEntity(entity) {
                ...
                newStudent.value.entidadId = entity.id; 
            ...
            */
            async function fetchEstados() {
                ...
                try {
                    ...
                    const response = await api.get(rutaObtenerEstadosAcademicos);
            ...
            async function runValidations(isSubmitting = false) {
                ...
                errors.value.estado = '';
                errors.value.entidad = '';
                const estado = newStudent.value.estado?.toString() ?? '';
                const entidadId = newStudent.value.entidadId?.toString() ?? '';
                ...
                if (!isEditMode.value) { 
                    ...
                    if (!entidadId && isSubmitting) {
                        errors.value.entidad = 'Debe seleccionar una entidad para el estudiante.';
                    }
                    ...
                    if (estado === "") {
                        if (isSubmitting) {
                            errors.value.estado = 'La selección de un estado académico es obligatorio.';
                        }
                        ...
                        if(!['1', '2', '3', '4', '5'].includes(estado)) {
                            errors.value.estado = 'Debe seleccionar un estado académico válido';
                        }
                    }
                }
            }
            ...
            const submitForm = async () => {
                ...
                if (newStudent.value.id) {
                    ...
                    dataToSend = {
                        ...
                        estado: newStudent.value.estado,
                    };
                    ...
                    dataToSend = {
                        id: newStudent.value.entidadId
                    };
                    emit('add-student', dataToSend);
                }
