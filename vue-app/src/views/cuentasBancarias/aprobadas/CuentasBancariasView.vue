<template>
  ...
  <div class="account-type-manager">
    ...
    <div class="table-responsive">
        ...
        <thead class="header-personalizado">
            <tr>
                ...
                <th class="text-center col-fecha_creacion">Fecha de aprobación</th>
                <th class="text-center col-fecha_actualizacion">Última modificación</th>
                <th class="text-center col-estado">Estado</th>
                <th class="text-center col-puede_inscribirse">¿Pueden hacerse operaciones con ella?</th>
        ...
        <tbody>
            ...
            <tr v-else-if="bankAccountTypes.length === 0">
                <td colspan="10" class="text-center">
                    <span class="no-results-message">No se encontraron cuentas bancarias. Intenta ajustar los filtros.</span>
                </td>
            </tr>
            <tr v-else v-for="bankAccount in bankAccountTypes" :key="bankAccount.id">
                ...
                <td class="">{{ formatDateTime(bankAccount.fechaAprobacion) }}</td>
                <td class="">{{ formatDateTime(bankAccount.fechaActualizacion) }}</td>

                <td class="">{{ bankAccount.estado.nombre }}</td>

                 <td class="">{{ bankAccount.estado.permite_operacion }}</td>
                ...
                <td class=" text-center">
                    <div class="d-flex flex-row flex-nowrap justify-content-center">
                        ...
                        <button 
                            ...
                            @click="showDetailsModal(bankAccount)" 
    ...
    <!-- Modal para crear o cambiar el estado de una cuenta bancaria -->
    <BankAccountFormModal
      :isVisible="isModalVisible"
      :initialData="bankAccountToEdit" 
      @close="closeModal"
    ...
    <BankAccountDetailsModal
        ...
        :bankAccountData="bankAccountToView"
...
<script setup>
    ...
    // ----------------------------------- Importaciones ----------------------------------------
        ...
        import BankAccountFormModal from './FormularioCuentasBancariasView.vue';

        import BankAccountDetailsModal from './CuentasBancariasDetailsModal.vue';
    ...
    // ----------------------------------- Variables ----------------------------------------
        ...
        // Rutas
            ...
            const rutaBuscar = `${rutaBase}Buscar/Aprobadas`

            // Crear cuenta bancaria
            const rutaCrear = `${rutaBase}CrearCuentaBancaria`
            ...
            // Cambiar estado cuenta bancaria
        ...
        // Para ver los datos de la cuenta
        const bankAccountToView = ref(null);
  ...
  // ----------------------------------- Funciones ----------------------------------------
      ...
      // ----------------------------------- API ----------------------------------------
            ...
            /**
            * Maneja el evento 'add-bankAccount' del modal llamando a la API.
            */   
            const addBankAccount = async (newAccountBankData) => {
                try {

                    // 1. Llama a la API (POST) para creación
                    const response = await api.post(rutaCrear, newAccountBankData);

                    exito('Éxito', 'Cuenta bancaria registrada. Esperando por aprobación.');

                    // No mandamos a actualizar la tabla ya que las cuentas registradas requieren aprobación antes de aparecer aquí
            ...
            /**
             * Maneja el evento 'update-bankAccount' del modal llamando a la API.
             */
            const updateBankAccount = async (updatedData) => {
    
                try {
                    // 1. Llama a la API (PUT) para actualizar la cuenta.
                    // La ruta incluye el ID: /api/accounts/:id
                    const response = await api.put(`${rutaCambiarEstado}/${updatedData.id}`, updatedData);

                    exito('Éxito', 'Cuenta bancaria actualizada correctamente.');
      ...
      // ----------------------------------- Modals ----------------------------------------
            ...
            // ----------------------------------- Creación / Edición ----------------------------------------
                ...
                */
                const openModal = (bankAccunt = null) => {
             ...
             */
            function showDetailsModal(bankAccount) {
                bankAccountToView.value = bankAccount;
            ...
            function closeDetailsModal() {
                ...
                bankAccountToView.value = null; // Limpiar los datos al cerrar
            }
