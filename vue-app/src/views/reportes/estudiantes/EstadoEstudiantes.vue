           ...
           isLoadingChart.value = true;
            try {
                ...
                const transformedData = [
                    ...
                    { label: 'Egresados', conteo: apiData.Egresado || 0 },
                    { label: 'Retirados', conteo: apiData.Retirado || 0 },
                    { label: 'Suspendidos', conteo: apiData.Suspendido || 0 },
                    { label: 'Morosos', conteo: apiData.Moroso || 0 }
                ];
    ...
    // ----------------------------------- Watchers ----------------------------------------
        ...
        watch(
            ...
            { 
                ...
                // debes llamar explícitamente a loadStudentsForChart() en onMounted.
            }
        );
