<template>
    ...
    <div class="page-container p-4">
        ...
        <h2 class="mb-4 title">Reportes y Análisis de Inscripciones</h2>
                ...
                <h2 class="accordion-header" :id="'heading-1'">
                    ...
                    >
                        <div class="d-flex align-items-center">
                            ...
                            <span class="ms-2">1. Estado Actual de las Inscripciones</span>
                        </div>
                ...
                <h2 class="accordion-header" :id="'heading-2'">
                    ...
                    >
                        <div class="d-flex align-items-center">
                            ...
                            <span class="ms-2">2. Inscripciones Realizadas a lo Largo del Tiempo</span>
                        </div>
                        <span class="accordion-icon">
                           <i class="bi bi-chevron-down"></i>
                        </span>
                ...
                <h2 class="accordion-header" :id="'heading-3'">
                    ...
                    >
                        <div class="d-flex align-items-center">
                            ...
                            <span class="ms-2">3. Inscripciones Modificadas a lo Largo del Tiempo</span>
                        </div>
                        <span class="accordion-icon">
                            <i class="bi bi-chevron-down"></i>
                        </span>
...
<script setup>
    ...
    import RegistrationStatusChart from './EstadoInscripciones.vue'; 

    import RegistrationCreationChart from './InscripcionesCreadas.vue'; 

    import RegistrationUpdateChart from './InscripcionesModificadas.vue'; 
