<template>
  <div class="analytics-manager">
    ...
    <div class="chart-container hover-lift p-4">
        <h3>Modificación de Entidades</h3>
        ...
        <MonitoreoChart 
            ...
            componentTitle="Conteo de Entidades por Mes"
...
// ------------------------------------- Variables  ------------------------------------
    // Rutas
        ...
        const rutaContar = `${rutaBase}ContarEntidades` 
...
// ------------------------------------- Funciones  ------------------------------------
    ...
    // ----------------------------------- API y Flujo de Datos ----------------------------------------
         ...
         */
        const loadEntitiesForChart = async (currentFilters = {}) => {
    ...
    // ----------------------------------- Watchers ----------------------------------------
        ...
        watch(
            ...
            (newFilters) => {
                ...
                searchTimeout = setTimeout(() => {
                    ...
                    loadEntitiesForChart(newFilters);
                }, 300); 
            }, 
            { 
                deep: true, 
                // CAMBIO CLAVE: Quitamos immediate: true.
                // La carga inicial la gestionará onMounted.
                // Cuando quitas immediate: true, solo responde a cambios.
                // Si quieres que responda a cambios Y cargue inicialmente, 
                // debes llamar explícitamente a loadEntitiesForChart() en onMounted.
            }
        );
        ...
        onMounted(async () => {
            ...
            await loadEntitiesForChart(filters.value);
