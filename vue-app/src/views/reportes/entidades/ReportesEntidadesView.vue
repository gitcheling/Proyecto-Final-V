<template>
    ...
    <div class="page-container p-4">
        ...
        <h2 class="mb-4 title">Reportes y Análisis de Entidades</h2>
                ...
                <h2 class="accordion-header" :id="'heading-1'">
                    ...
                    >
                        <div class="d-flex align-items-center">
                            ...
                            <span class="ms-2">1. Estado Actual de las Entidades</span>
                        </div>
                ...
                <h2 class="accordion-header" :id="'heading-2'">
                    ...
                    >
                        <div class="d-flex align-items-center">
                            ...
                            <span class="ms-2">2. Entidades Registradas a lo Largo del Tiempo</span>
                        </div>
                        <span class="accordion-icon">
                ...
                <h2 class="accordion-header" :id="'heading-3'">
                    ...
                    >
                        <div class="d-flex align-items-center">
                            ...
                            <span class="ms-2">3. Entidades Modificadas a lo Largo del Tiempo</span>
                        </div>
                        <span class="accordion-icon">
...
<script setup>
    ...
    import EntityStatusChart from './EstadoEntidades.vue'; 

    import EntityCreationChart from './EntidadesCreadas.vue'; 

    import EntityUpdateChart from './EntidadesModificadas.vue'; 
