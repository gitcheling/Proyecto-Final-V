<template>
    ...
    <div class="page-container p-4">
        ...
        <h2 class="mb-4 title">Reportes y Análisis de Grupos</h2>
                ...
                <h2 class="accordion-header" :id="'heading-1'">
                    ...
                    >
                        <div class="d-flex align-items-center">
                            ...
                            <span class="ms-2">1. Estado Actual de los Grupos</span>
                        </div>
                ...
                <h2 class="accordion-header" :id="'heading-2'">
                    ...
                    >
                        <div class="d-flex align-items-center">
                            ...
                            <span class="ms-2">2. Grupos Registrados a lo Largo del Tiempo</span>
                        </div>
                        <span class="accordion-icon">
                           <i class="bi bi-chevron-down"></i>
                        </span>
                ...
                <h2 class="accordion-header" :id="'heading-3'">
                    ...
                    >
                        <div class="d-flex align-items-center">
                            ...
                            <span class="ms-2">3. Grupos Modificados a lo Largo del Tiempo</span>
                        </div>
                        <span class="accordion-icon">
                            <i class="bi bi-chevron-down"></i>
                        </span>
...
<script setup>
    ...
    import GroupStatusChart from './EstadoGrupos.vue'; 

    import GroupCreationChart from './GruposCreados.vue'; 

    import GroupUpdateChart from './GruposModificados.vue'; 
