  ...
  <div class="analytics-manager">
    ...
    <div class="chart-container hover-lift p-4">
        ...
        <MonitoreoChart 
            ...
            componentTitle="Conteo de Grupos por Mes"
...
// ------------------------------------- Variables  ------------------------------------
      ...
      // Rutas
            ...
            // Ruta contar
            const rutaContar = `${rutaBase}ContarGrupos` 
...
// ------------------------------------- Funciones  ------------------------------------
    ...
    // ----------------------------------- API y Flujo de Datos ----------------------------------------
         ...
         */
        const loadGroupsForChart = async (currentFilters = {}) => {
    ...
    // ----------------------------------- Watchers ----------------------------------------
        ...
        onMounted(async () => {
            ...
            await loadGroupsForChart(filters.value);
