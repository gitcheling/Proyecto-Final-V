<template>
  ...
  <div class="analytics-manager">
    ...
    <div class="chart-container hover-lift p-4">
        <h3>Estado de las Cuentas Bancarias </h3>
           ...
           isLoadingChart.value = true;
            try {
                ...
                const transformedData = [
                    ...
                    { label: 'Inactivas', conteo: apiData.Inactiva || 0 },
                    { label: 'Bloqueadas', conteo: apiData.Bloqueada || 0 },
                    { label: 'Cerradas', conteo: apiData.Cerrada || 0 },
                    { label: 'Pendientes de Validación', conteo: apiData['Pendiente de Validación'] || 0 }
                ];
