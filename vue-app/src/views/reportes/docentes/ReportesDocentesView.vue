<template>
    ...
    <div class="page-container p-4">
        ...
        <h2 class="mb-4 title">Reportes y Análisis de Docentes</h2>
                ...
                <h2 class="accordion-header" :id="'heading-1'">
                    ...
                    >
                        <div class="d-flex align-items-center">
                            ...
                            <span class="ms-2">1. Estado Actual de los Docentes</span>
                        </div>
...
<script setup>
    ...
    import TeacherCreationChart from './DocentesCreados.vue'; 

    import TeacherUpdateChart from './DocentesModificados.vue'; 

    import TeacherStatusChart from './EstadoDocentes.vue'; 
