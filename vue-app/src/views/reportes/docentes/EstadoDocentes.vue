  ...
  <div class="analytics-manager">
    ...
    <div class="chart-container hover-lift p-4">
        ...
        <MonitoreoChart 
            ...
            componentTitle="Estado de Docentes"
...
// ------------------------------------- Funciones  ------------------------------------
    ...
    // ----------------------------------- API y Flujo de Datos ----------------------------------------
         ...
         */
        const loadTeachersForChart = async (currentFilters = {}) => {
           ...
           isLoadingChart.value = true;
            try {
                ...
                const transformedData = [
                    ...
                    { label: 'Ausentes Autorizados', conteo: apiData["Ausencia Autorizada"] || 0 },
    ...
    // ----------------------------------- Watchers ----------------------------------------
        ...
        watch(
            ...
            (newFilters) => {
                ...
                searchTimeout = setTimeout(() => {
                    ...
                    loadTeachersForChart(newFilters);
                }, 300); 
            }, 
            { 
                deep: true, 
        ...
        onMounted(async () => {
            ...
            await loadTeachersForChart(filters.value);
