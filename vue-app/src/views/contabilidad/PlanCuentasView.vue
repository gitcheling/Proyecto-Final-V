<template>
  ...
  <div class="account-type-manager">
    ...
    <h2>Gestión del Plan de Cuentas</h2>
    <div class="mb-3">
    ...
    <div 
    v-if="accountTypes.length > 0 && !isLoadingTable" 
    ...
    <div class="table-card-wrapper hover-lift">
        <div class="table-responsive">
            ...
            <tbody>
                ...
                <tr v-if="accountTypes.length > 0" v-for="account in accountTypes" :key="account.id">
    ...
    <div 
        v-if="!isLoadingTable && accountTypes.length === 0" 
        class="text-center py-5 mb-5"
    >
        <div class="no-results-center-badge">
            <i class="bi bi-x-circle-fill me-2"></i> No se encontraron cuentas con los filtros aplicados.
...
<script setup>
    ...
    // ----------------------------------- Variables ----------------------------------------
        ...
        const resultsText = computed(() => {
            const count = accountTypes.value.length;
            if (count === 1) {
                return `🔍 Se encontró ${count} cuenta con los filtros aplicados.`;
            } else {
                return `🔍 Se encontraron ${count} cuentas con los filtros aplicados.`;
            }
        });
